<?php
  ...
  $connection= mysqli_connect($host, $user, $pass, $db, $port)or die(mysql_error());
   if(isset($_POST['register'])){
     ...
     $query= "SELECT * FROM Relacion_profesor_producto WHERE idProducto = '$idart' AND idProfesor='$idpro'";
     $result= mysqli_query($connection, $query);
     if ($row= mysqli_fetch_assoc($result)) {
        echo "registrado" ;
      }else{
        $query= "INSERT INTO Relacion_profesor_producto (idProfesor, idProducto) VALUES ('$idpro','$idart')";
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Art&iacute;culo detalle</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Articulo
          <?php
            $idart= $_GET["idArt"];
            echo "<a class='btn btn-primary pull-right' href='editarArticulo.php?idart=".$idart."'>Editar este articulo</a>";
          ?>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <?php
                ...
                $query= "SELECT * FROM Producto INNER JOIN Revista ON Producto.idRevista = Revista.id  WHERE Producto.id = '$id'";
                $result= mysqli_query($connection, $query);
                  while ($row= mysqli_fetch_assoc($result)) {
                    echo "<div class='form-group'>
                            <p>Titulo del artículo: ". $row['tituloArticulo'] ."</p>
                        </div>
                        <div class='form-group'>
                            <p>Idioma: ". $row['idioma'] ."</p>
                        </div>
                        <div class='form-group'>
                            <p>Nombre de revista: ". $row['nombre'] ."</p>
                        </div>
                        <div class='form-group'>
                            <p>Ciudad: ". $row['ciudad'] ."</p>
                        </div>
                        <div class='form-group'>
                            <p>Estado: ". $row['estado'] ." - Ultimo cambio: ".$row['fechaup']."</p>
                        </div>" ;
                      if($row['estado']==="Publicado"){
                      echo"<div class='form-group'>
                            <div class='form-row'>
                              <div class='col-md-6'>
                                <p>Pagina inicial: ".$row['paginaInicial']."</p>
                              </div>
                              <div class='col-md-6'>
                                <p>Paginal final: ".$row['paginaFinal']."</p>
                              </div>
                            </div>
                          </div>
                          <div class='form-group'>
                            <div class='form-row'>
                              <div class='col-md-6'>
                                <p>Fecha de publicación: ".$row['fecha']."</p>
                              </div>
                              <div class='col-md-6'>
                                <p>Volumen de la revista: ".$row['volumen']."</p>
                              </div>
                            </div>
                          </div>
                          <div class='form-group'>
                            <div class='form-row'>
                              <div class='col-md-6'>
                                <p>Fascículo de revista: ".$row['fasciculoRevista']."</p>
                              </div>
                              <div class='col-md-6'>
                                <p>Serie de revista: ".$row['serieRevista']."</p>
                              </div>
                            </div>
                          </div>
                          <div class='form-group'>
                          <p>Sitio web: ".$row['sitioWeb']."</p>
                            <div class='form-row'>
                              <div class='col-md-6'>
                                <p>Medio de divulgación: ".$row['medioDivulgacion']."</p>
                              </div>
                              <div class='col-md-6'>
                                <p>DOI: ".$row['doi']."</p>
                              </div>
                          ...
                          <div class='form-group'>
                            <div class='form-row'>
                              <div class='col-md-4'>
                                <p>Cuartil Scopus: ".$row['cuartilScopus']."</p>
                              </div>
                              <div class='col-md-4'>
                                <p>Cuartil ISI: ".$row['cuartilIsci']."</p>
                              </div>
                              <div class='col-md-4'>
                                <p>Cuartil Index: ".$row['cuartilIndex']."</p>
                              </div>
                            </div>
                          </div>";
                      }
            ...
            <div class="card-header">
              <div class="form-group" >
                <form method="post" action="">
                  <i class="fa fa-table"></i> Tabla de autores
                  <input class="btn btn-primary pull-right" type="submit" name="register" value="Añadir un nuevo autor">
                  <select class="btn pull-right" style="border-width: 1px; border-color:  black;" id="autorInput" name="autorInput" required>
                  <?php
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <?php
                echo "<a class='btn btn-primary' href='editarAutores.php?idArt=".$id."'>Eliminar autores de la lista</a>";
                ?>
