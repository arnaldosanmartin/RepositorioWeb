<?php
  ...
  $connection= mysqli_connect($host, $user, $pass, $db, $port)or die(mysql_error());
   ...
   if(isset($_POST['register'])){
     $idgrup= $_POST["grupoInput"];
     $idpro= $_POST['profesorInput'];
     $query= "SELECT * FROM Relacion_profesor_grupo WHERE idGrupo = '$idgrup' AND idProfesor='$idpro'";
     $result= mysqli_query($connection, $query);
     if ($row= mysqli_fetch_assoc($result)) {
        $msg = "El profesor ya hace parte de este grupo!";
      }else{
        $query= "INSERT INTO Relacion_profesor_grupo (idProfesor, idGrupo) VALUES ('$idpro','$idgrup')";
        if ($connection->query($query)=== TRUE) {
            $msg = "El profesor se ha registrado en el grupo exitosamente!";
        } else {
...
<head>
  ...
  <title>Relación con grupos</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Relación con grupo</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Relacion<a class="btn btn-primary pull-right" href="registerGroup.php">Registrar un nuevo grupo</a>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <form method="post" action="">
              ...
              <br></br>
              <i class="fa fa-table"></i>
              <label for="grupoInput">Listado de grupos</label>
              <select class="form-control" id="grupoInput" name="grupoInput" required>
              <?php
              ...
              <br></br>
              <input class="btn btn-primary pull-right" type="submit" name="register" value="Registrar un nuevo integrante">
              <?php echo $msg ?>
            </form>
