<?php
  ...
  $connection= mysqli_connect($host, $user, $pass, $db, $port)or die(mysql_error());
   if(isset($_POST['register'])){
     $iddep= $_POST["depInput"];
     $idpro= $_POST['profesorInput'];
     $rol=$_POST['rolInput'];
     $intensidad=$_POST['horaInput'];
     
     $query= "SELECT * FROM Relacion_profesor_departamento WHERE idDepartamento = '$iddep' AND idProfesor='$idpro'";
     $result= mysqli_query($connection, $query);
     if ($row= mysqli_fetch_assoc($result)) {
        $msg = "El profesor ya hace parte de este departamento!";
     }else{
        $query= "INSERT INTO Relacion_profesor_departamento (idProfesor, idDepartamento,rol,intensidadHoraria) VALUES ('$idpro','$iddep','$rol','$intensidad')";
        if ($connection->query($query)=== TRUE) {
        $msg = "El profesor se ha registrado en el departamento exitosamente!";
        } else {
...
<head>
  ...
  <title>Relación con departamentos</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Relación con departamento</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Relacion <a class="btn btn-primary pull-right" href="registerDept.php">Registrar un nuevo departamento</a>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <form method="post" action="">
              ...
              <label for="profesorInput">Listado de profesores</label>
              ...
              <i class="fa fa-table"></i>
              <label for="depInput">Listado de departamentos</label>
              <select class="form-control" id="depInput" name="depInput" required>
              <?php
              ...
              <div class="form-group">
                <label for="rolInput">Rol en el departamento</label>
                <input class="form-control" name="rolInput" id="rolInput" required>
              </div>
              <div class="form-group">
                <label for="horaInput">Intensidad horaria dedicada</label>
                <input class="form-control" name="horaInput" id="horaInput" required>
              </div>
              
              <input class="btn btn-primary pull-right" type="submit" name="register" value="Relacionar este profesor">
              <?php echo $msg; ?>
            </form>
